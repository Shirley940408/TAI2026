...
Usage:
    ...
    python case_deep_trace.py --net fc6 --spec ../test_cases/fc6/img3_0.08500.txt --target-label 1
    python case_deep_trace.py --net fc1 --spec ../test_cases/fc1/img2_0.11500.txt --target-label 1
...
def main():
    ...
    parser.add_argument('--target-label', type=int, required=True,
                         help='Class index still failing (0-9), or -1 to list all per-class margins first.')
...
# python case_deep_trace.py --net fc6 --spec ../test_cases/fc6/img3_0.08500.txt --target-label 1
# === fc6 ../test_cases/fc6/img3_0.08500.txt | true_label=0 target_label=1 eps=0.085 ===

# baseline margin (0/1 heuristic, no optimization): -3.2950

# per-ReLU-layer stats:
#   relu[0]: unstable=17/100 (17.0%)  box_wins_somewhere=0  mean_width=1.1765  max_width=3.4208
#   relu[1]: unstable=19/100 (19.0%)  box_wins_somewhere=10  mean_width=0.7850  max_width=4.3549
#   relu[2]: unstable=17/100 (17.0%)  box_wins_somewhere=9  mean_width=0.7502  max_width=5.1879
#   relu[3]: unstable=29/100 (29.0%)  box_wins_somewhere=30  mean_width=1.9520  max_width=8.0400

# per-layer ablation (UNSOUND, diagnostic only -- "if this layer had zero relaxation error"):
#   zero-out relu[1]: margin -3.2950 -> 15.0202  (Δ=+18.3152)  <-- biggest contributor
#   zero-out relu[0]: margin -3.2950 -> 8.7644  (Δ=+12.0593)
#   zero-out relu[2]: margin -3.2950 -> 8.2537  (Δ=+11.5487)
#   zero-out relu[3]: margin -3.2950 -> 4.7838  (Δ=+8.0787)