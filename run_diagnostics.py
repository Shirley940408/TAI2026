...
Usage:
    python run_diagnostics.py --tests-dir ../test_cases
    python run_diagnostics.py --tests-dir ../test_cases --verifier verifier    
    python run_diagnostics.py --tests-dir ../test_cases --net fc3
"""
