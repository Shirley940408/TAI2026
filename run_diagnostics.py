"""
Usage (run from the same directory as verifier_debug.py, e.g. your `code/` dir):

    python run_diagnostics.py --tests-dir ../test_cases --gt ../test_cases/gt.txt
...
from verifier_debug import parse_spec, load_network, analyze, INPUT_SIZE, DEVICE
import torch
